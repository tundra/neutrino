...
// the anchor.
#define DERIVED_OBJECT_FIELD_OFFSET(N) (N * ((int32_t) kValueSize))
...
static const int32_t kBarrierStatePayloadOffset = DERIVED_OBJECT_FIELD_OFFSET(-1);
static const int32_t kBarrierStatePreviousOffset = DERIVED_OBJECT_FIELD_OFFSET(-2);
...
static const int32_t kEscapeStateStackPointerOffset = DERIVED_OBJECT_FIELD_OFFSET(-3);
static const int32_t kEscapeStateFramePointerOffset = DERIVED_OBJECT_FIELD_OFFSET(-4);
static const int32_t kEscapeStateLimitPointerOffset = DERIVED_OBJECT_FIELD_OFFSET(-5);
static const int32_t kEscapeStateFlagsOffset = DERIVED_OBJECT_FIELD_OFFSET(-6);
static const int32_t kEscapeStatePcOffset = DERIVED_OBJECT_FIELD_OFFSET(-7);
...
static const int32_t kRefractionPointFramePointerOffset = DERIVED_OBJECT_FIELD_OFFSET(1);
...
static const int32_t kBlockSectionMethodspaceOffset = DERIVED_OBJECT_FIELD_OFFSET(2);
