...
//
// The marker is used to identify the location that produced the not found
// condition. If you add a new call you can use a random marker, for instance
// generated by calling
//
//   hexdump -n4 -e '"0x" 1/4 "%08x" "\n"' /dev/random
