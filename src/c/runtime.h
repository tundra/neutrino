...
typedef struct {
  ...
  size_t remaining;
} allocation_failure_fuzzer_t;

// Initializes an allocation failure fuzzer according to the given runtime
// config.
...
struct runtime_t {
  ...
  allocation_failure_fuzzer_t *allocation_failure_fuzzer;
};
