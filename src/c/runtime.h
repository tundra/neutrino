...
#undef __EMIT_SINGLETON_ENUM__
  ...
  // Basic family species and protocols. Family protocol enums have to be
  // generated by a macro because they contain a comma which would mess up the
  // macro invocation otherwise.
#define __EMIT_FAMILY_PROTOCOL__(family) , rk_##family##_protocol
#define __EMIT_PER_FAMILY_ENUMS__(Family, family, CMP, CID, CNT, SUR, NOL, FIX, EMT) \
  , rk_##family##_species                                                      \
